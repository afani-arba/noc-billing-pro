...
Write-Host "Copying WallDisplayPage.jsx to noc home..."
echo y | & $pscp -P $port -pw $pass "e:\noc-billing-pro\frontend\src\pages\WallDisplayPage.jsx" "$user@${srv}:/home/noc/WallDisplayPage.jsx"

Write-Host "Moving with sudo..."
echo y | & $plink -ssh "$user@$srv" -P $port -pw $pass -batch -t "echo $pass | sudo -S mv /home/noc/WallDisplayPage.jsx /opt/noc-billing-pro/frontend/src/pages/WallDisplayPage.jsx"
