...
Write-Host "Copying PeeringEyePage.jsx to noc home..."
echo y | & $pscp -P $port -pw $pass "e:\noc-billing-pro\frontend\src\pages\PeeringEyePage.jsx" "$user@${srv}:/home/noc/PeeringEyePage.jsx"

Write-Host "Moving with sudo..."
echo y | & $plink -ssh "$user@$srv" -P $port -pw $pass -batch -t "echo $pass | sudo -S mv /home/noc/PeeringEyePage.jsx /opt/noc-billing-pro/frontend/src/pages/PeeringEyePage.jsx"
